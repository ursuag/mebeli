...
begin
  ...
  //измен€ть дату акта могут только пользователи группы BUHGALTER или ADMIN
...
{      DBG_Listy.Enabled:=false;
      ...
      ShowMessage('ƒата документа меньше даты запрета редактировани€');
