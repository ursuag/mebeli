object F_Cassa_prihod: TF_Cassa_prihod
  ...
  object Label2: TLabel
    ...
    Width = 157
    Height = 19
    Caption = #1055#1056#1048#1061#1054#1044' '#1055#1054' '#1050#1040#1057#1057#1045
    Font.Charset = RUSSIAN_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object DS_Bank_Prihod: TDataSource
    DataSet = IB_Cassa_Prihod
    Left = 632
    Top = 216
  end
  object IB_Cassa_Prihod: TIBDataSet
    Database = DM_Mebeli.DB_Mebeli
    Transaction = DM_Mebeli.IBTransaction1
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from cassa_prihod'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into cassa_prihod'
      
        '  (ID, DATE_CAS, SUMMA, ID_CONTRAGENT, ID_SOTRUDNIK, ID_STATYA_D' +
        'OHODA, '
      '   DESCRIPTION)'
      'values'
    ...
    Left = 632
    Top = 168
    object IB_Cassa_PrihodID: TIntegerField
      FieldName = 'ID'
      Origin = 'BANK_PRIHOD.ID'
      Required = True
    end
    object IB_Cassa_PrihodSUMMA: TIBBCDField
      FieldName = 'SUMMA'
    ...
    object IB_Cassa_PrihodID_CONTRAGENT: TIntegerField
      FieldName = 'ID_CONTRAGENT'
      Origin = 'BANK_PRIHOD.ID_CONTRAGENT'
    end
    object IB_Cassa_PrihodID_SOTRUDNIK: TIntegerField
      FieldName = 'ID_SOTRUDNIK'
      Origin = 'BANK_PRIHOD.ID_SOTRUDNIK'
    end
    object IB_Cassa_PrihodID_STATYA_DOHODA: TIntegerField
      FieldName = 'ID_STATYA_DOHODA'
      Origin = 'BANK_PRIHOD.ID_STATYA_DOHODA'
      Required = True
    end
    object IB_Cassa_PrihodCONTRAGENT_NAME: TStringField
      FieldKind = fkLookup
    ...
    object IB_Cassa_PrihodSOTRUDNIK_NAME: TStringField
      FieldKind = fkLookup
    ...
    object IB_Cassa_PrihodSTATYA_NAME: TStringField
      FieldKind = fkLookup
    ...
    object IB_Cassa_PrihodDESCRIPTION: TIBStringField
      FieldName = 'DESCRIPTION'
      Origin = 'BANK_PRIHOD.DESCRIPTION'
      Size = 200
    end
    object IB_Cassa_PrihodDATE_CAS: TDateField
      FieldName = 'DATE_CAS'
